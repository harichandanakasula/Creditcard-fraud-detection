...
main = tkinter.Tk()
main.title("Credit Card Fraud Detection Using Random Forest Algorithm") #designing main screen
w=main.winfo_screenwidth()
h=main.winfo_screenheight()
imgTemp=Image.open("best-credit-cards.jpg")
img2=imgTemp.resize((w,h))
img=ImageTk.PhotoImage(img2)
label = Label(main,image=img)
label.place(height=h,width=w)
...
def upload(): #function to upload dataset
    global filename
...
predictButton = Button(main, text="Detect Fraud From Sample Data", command=predicts)
